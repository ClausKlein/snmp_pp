 ...
 */
AgentLogImpl::AgentLogImpl(FILE* fp) : AgentLog() { set_dest(fp); }
 ...
 */
AgentLogImpl::AgentLogImpl(const char* fname) : AgentLog() { set_dest(fname); }
 ...
 */
LogEntry* AgentLogImpl::create_log_entry(
