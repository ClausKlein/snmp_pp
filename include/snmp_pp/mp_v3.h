...
protected:
    ...
    int snmp_parse(Snmp* snmp_session, struct snmp_pdu* pdu,
        ...
        OctetStr& securityName, OctetStr& contextEngineID,
        OctetStr& contextName, SmiINT32& securityLevel,
        SmiINT32& msgSecurityModel, snmp_version& spp_version,
     ...
     * @return - SNMPv3_MP_OK or any error listed in snmperr.h
     */
    int snmp_build(struct snmp_pdu* pdu, unsigned char* packet,
        int*            out_length, // maximum Bytes in packet
        const OctetStr& securityEngineID, const OctetStr& securityNameIn,
        SmiINT32 securityModel, SmiINT32 securityLevel,
        const OctetStr& contextEngineID, const OctetStr& contextName);
...
private:
    ...
    public:
        ...
        /**
         * Get the upper limit of the number of entries in this engine ID
         * cache.
         ...
         * cache. Calls of this method with a cache size of 0 or less are
         * ignored.
    ...
    public:
         ...
         *                        OUT: The structure as received by the USM
