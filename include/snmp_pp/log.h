...
public:
    ...
    {
        return (unsigned char)(type & LOG_CLASS_MASK);
    }
    ...
    {
        return (unsigned char)(type & LOG_LEVEL_MASK);
    }
...
public:
     ...
     * @note A error log of level 0 will stop program execution!
     */
    LogEntryImpl(const char* const n, unsigned char t) : LogEntry(n, t)
    {
...
public:
     ...
     *  In case a non-existent profile is chosen, "original" is used.
     */
    ...
    virtual LogEntry* create_log_entry(
        const char* const name, unsigned char t) const = 0;
